    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <div>
                    <div class="flex_img justify-center">
                        <a href="/" class="block">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('users.create') }}" class="btn btn-md btn-success mb-3">Create user</a>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Are you sure ?');" action="{{ route('users.destroy', $user->id) }}" method="POST">
                                            ...
                                            <a href="{{ route('users.change-password', $user->id) }}" class="btn btn-sm btn-primary">CHANGE PASSWORD</a>
                                            @csrf
                                            @method('DELETE')
